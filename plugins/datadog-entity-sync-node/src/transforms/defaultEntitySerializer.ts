...
import type { ComponentEntity, ApiEntity, SystemEntity, ResourceEntity, Entity } from '@backstage/catalog-model';
import {
...
): asserts entity is ComponentEntity | ApiEntity | SystemEntity | ResourceEntity {
    if (!(isComponentEntity(entity) || isApiEntity(entity) || isSystemEntity(entity) || isResourceEntity(entity)))
        throw new Error(
...
function labelsToTags(entity: ComponentEntity | ApiEntity | SystemEntity | ResourceEntity) {
